...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `empresa` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci */;
...
CREATE TABLE `centrostrabajo` (
  ...
  `nombreCentroTrabajo` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `direccionCentroTrabajo` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `departamentos` (
  ...
  `tipoDirectorDepartamento` char(1) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `presupuestoDepartamento` decimal(10,0) DEFAULT NULL,
  `idDepartamentoFK` int(11) DEFAULT NULL,
  `nombreDepartamento` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`idDepartamento`),
  KEY `idCentroTrabajoFK1` (`idCentroTrabajoFK`),
  KEY `idEmpleadoFK1` (`idEmpleadoFK`),
  KEY `idDepartamentoFK1` (`idDepartamentoFK`),
  CONSTRAINT `idCentroTrabajoFK1` FOREIGN KEY (`idCentroTrabajoFK`) REFERENCES `centrostrabajo` (`idCentroTrabajo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idEmpleadoFK1` FOREIGN KEY (`idEmpleadoFK`) REFERENCES `empleados` (`idEmpleado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idDepartamentoFK1` FOREIGN KEY (`idDepartamentoFK`) REFERENCES `departamentos` (`idDepartamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleados` (
  ...
  `idDepartamentoFK` int(11) DEFAULT NULL,
  `extensionEmpleado` smallint(6) DEFAULT NULL,
  ...
  `hijosEmpleado` smallint(6) DEFAULT NULL,
  `nombreEmpleado` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`idEmpleado`),
  KEY `idDepartamentoFK2` (`idDepartamentoFK`),
  CONSTRAINT `idDepartamentoFK2` FOREIGN KEY (`idDepartamentoFK`) REFERENCES `departamentos` (`idDepartamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-04-30 11:18:36